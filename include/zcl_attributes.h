...
/* Check structure/selectors/unique IDs, not value types or backing data.
 * Standard declarations allow 0000..4FFF and F000..FFFE (ZCL R8 Table 2-8);
 * manufacturer-specific declarations allow the full 16-bit ID range.
 */
