...
| [Raw IRND acquisition](ARCHITECTURE.md#isolated-raw-irnd-acquisition) | One reset-exclusive1..1024-bit no-sync RX capture, actual timer/work bounds, exact packing and partial-failure metadata; real health-core composition and both-board software proofs | No board linkage or hardware acceptance yet; no normal-radio handoff, independence guarantee, qualified entropy or security RNG |
