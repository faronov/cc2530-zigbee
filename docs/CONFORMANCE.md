...
| [Boot-disarmed TX fixture](RADIO_TX_FIXTURE.md) | Separate ARM/RUN, one conditional-clear channel15/raw05 attempt, actual clock/FIFO/TX and retained faults; offline host/image/simulator evidence | Physical TX/CCA, independent on-air bytes/FCS, calibration and fault recovery remain separate; no ACK, retry, same-reset RX adapter or MAC/network claim |
