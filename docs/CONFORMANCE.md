...
| [Boot-disarmed TX fixture](RADIO_TX_FIXTURE.md) | Current channel26/raw05 profile has offline proofs only; separate [previous LG channel15/raw05 PHY_DONE and independent body match](DEBUGGING.md#2026-09-19-lg-single-attempt-tx-acceptance) | Channel26 RF, physical busy-channel, independent FCS, calibration and fault recovery remain open; no ACK, retry, same-reset RX adapter or MAC/network claim |
