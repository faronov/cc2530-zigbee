...
| RADIO-AUTOACK-01 | Reset-exclusive filtered receiver, verified address/profile, complete-frame servicing and non-aborting stop/drain | TI SWRU191F23.9.5,23.9.8,23.10 and Fig23-20; [primary limits and ownership](RADIO_AUTOACK.md) | Actual timebase/owner/caller composition / host-tested, image-checked, simulated; no board image or silicon ACK evidence | Preparatory M3/#48; broadcast and ACK-FCF compatibility, #40 capture, continuous ordinary-TX/RX ownership, IFS and MAC/POLL closure remain open |
